...
class InvestigationSpec extends FunSpec with TestEnvironment with BetterRasterMatchers with BeforeAndAfterAll {
  it("should compute the histogram for the layer") {
    //val path = "s3://azavea-datahub/raw/nlcd/nlcd_2011_landcover_full_raster_30m/nlcd_2011_landcover_2011_01_18.tif"
    val path = "s3://azavea-datahub/raw/nlcd/nlcd_2011_landcover_full_raster_30m/nlcd_2011_landcover_2011_02_67.tif"
